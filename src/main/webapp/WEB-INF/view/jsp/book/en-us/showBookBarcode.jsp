...
<div style="width: 650px; height: 400px; margin: 100px auto 0; border: #dcdcdc solid 1px; border-radius: 5px ">
    <div style="width:11em; margin: 50px auto;">
        <p style="width: 100%; text-align: center; margin-bottom: 0;">Bibliosoft Library</p>
        ...
        <a class="btn btn-outline-success btn-block" href="#" style="margin-top: 50px">Print barcode</a>
    </div>
</div>
</body>
</html>
